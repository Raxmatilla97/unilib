...
export default function LeaderboardPage() {
    ...
    return (
        <div className="min-h-screen bg-background relative overflow-hidden">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full md:w-[800px] h-[400px] bg-yellow-500/5 blur-[100px] rounded-full opacity-60 pointer-events-none" />
